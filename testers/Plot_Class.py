...
class Plot:
    ...
    def save_individual_graph(self,prompt_metric,answer_metric,save_path):
        self.generate_individual_figure(prompt_metric,answer_metric).write_html(save_path)

if __name__ == "__main__":
    inputfile_path = os.path.join("C:\\","Users","orendi", "Documents", "EmojiCrypt-main", "Emojicrypt", "testers",
                                   "metrics", "30-7-Test-Result", "azure_metric")

    metrics = ["prompt_metric","answer_metric"]
    #graph.show_individual_graph(["prompt_metric_similarity"],["answer_metric"],5)
